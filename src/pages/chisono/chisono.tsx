...
export const ChiSono = () => {
  const techImages = [
    { alt: 'logo di react', imageUrl: 'src/assets/react-icon.png', width: 100 },
    { alt: 'logo di typescript', imageUrl: 'src/assets/ts-icon.png', width: 40 },
    { alt: 'logo di javascript', imageUrl: 'src/assets/JS-iconpng.png', width: 40 },
    { alt: 'logo di html', imageUrl: 'src/assets/html-icon.png', width: 40 },
    { alt: 'logo di css', imageUrl: 'src/assets/css-icon.png', width: 47 },
    {
      alt: 'logo di visual studio code',
      imageUrl: 'src/assets/vscode-icon.png',
      width: 35
    },
    { alt: 'logo di git', imageUrl: 'src/assets/git-icon.png', width: 40 }
  ]
